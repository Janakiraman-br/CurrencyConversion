...
class CurrencyProjectApplicationTests {
		...
		public void addProductTest() {
			Mono<CurrencyConversionDto> productDtoMono = Mono.just(new CurrencyConversionDto( "USD", "ads", 1, true, "JKR",null));
	...
	public void getProductsTest(){
		Flux<CurrencyConversionDto> productDtoFlux=Flux.just(new CurrencyConversionDto("USD", "ads", 1, true, "JKR",null));
		...
		StepVerifier.create(responseBody)
				.expectSubscription()
				.expectNext(new CurrencyConversionDto( "USD", "ads", 1, true, "JKR",null))
	...
	public void addSavedProductTest() {
		Mono<CurrencyConversionSavedSearchDto> productDtoMono = Mono.just(new CurrencyConversionSavedSearchDto( "USD", "ads", 1, true, "JKR",null));
	...
	public void getSavedSearchTest(){
		Flux<CurrencyConversionSavedSearchDto> productDtoFlux=Flux.just(new CurrencyConversionSavedSearchDto("USD", "ads", 1, true, "JKR",null));
		...
		StepVerifier.create(responseBody)
				.expectSubscription()
				.expectNext(new CurrencyConversionSavedSearchDto( "USD", "ads", 1, true, "JKR",null))
